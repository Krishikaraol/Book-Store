...
// import img from '../../public/formal_photo.jpeg'
const About = () => {
  return (
    <div className="max-w-4xl mx-auto p-8 bg-white shadow-lg rounded-lg mt-20 pt-10">
      <h1 className="text-3xl font-bold mb-6 text-pink-500">About Us</h1>
      
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-pink-500">Our Story</h2>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-pink-500">Our Mission</h2>
        <p className="text-gray-700 leading-relaxed">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-pink-500">Meet the Team</h2>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-pink-500">Our Values</h2>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4 text-pink-500">Contact Us</h2>
        <p className="text-gray-700 leading-relaxed">
